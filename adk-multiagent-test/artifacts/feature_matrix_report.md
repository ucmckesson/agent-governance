...
| session span attributes present | PASS | span_count=54 |
| delegation span present | PASS | search span name agent_delegation |
| cost span present | PASS | search span name llm_cost |
| cloud logging trace/span fields present | PASS | entries=54 |
| runtime metrics snapshot generated | PASS | {"requests_total": 4, "errors_total": 0, "error_rate": 0.0, "request_p95_latency_ms": 4, "delegations_total": 2, "cost_usd_total": 0.0, "input_tokens_total": 36, "output_tokens_total": 36, "tool_analy |
| delegation edges tracked | PASS | [{'source_agent': 'orchestrator', 'target_agent': 'research_agent', 'count': 1}, {'source_agent': 'orchestrator', 'target_agent': 'validator_agent', 'count': 1}] |
| dlp model_armor provider selectable | PASS | model_armor |
| dlp provider differentiation | PASS | sdp=6 model_armor=4 |
| annotation export works | PASS | items=4 |
...
|---|---|---|---|
| session-clean | What is the capital of France? | research_agent | Research result: Paris |
...
| session-topic | Tell me about banned_topic | none | I can route research or validation requests. |